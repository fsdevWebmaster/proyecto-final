...
//Para testing en local
const testMongoURI = process.env.LOCAL_MONGO_URI_TESTING; // Obtener la URL de conexión para testing desde las variables de entorno


export const connectDB = async () => {
  try {
    // let mongoURI = localMongoURI; // Configuración inicial para desarrollo local
    let mongoURI = testMongoURI; // Configuración inicial para desarrollo local
